...
then
  ...
  sed -i 's/cd \/data\/openpilot/cd \/data\/openpilot\ncp \/data\/communitypilot_scripts\/ai\.comma\.plus\.offroad\.apk \/data\/openpilot\/apk\//' /data/data/com.termux/files/continue.sh
fi
